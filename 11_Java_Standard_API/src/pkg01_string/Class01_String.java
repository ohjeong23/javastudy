...
public class Class01_String {
  ...
  public static void method2() {
    ...
    //String Literal : "문자열" 
    //String Literal 은 JVM 이 관리한다. -> 동일한 Literal 은 재사용한다. str1 str2 주소값이 같음. 같은애 참조
 ...
 //특정 문자열의 인덱스를 찾을 때 사용.
  ...
  public static void method13() {
    ...
    // join : String[]의 모든 요소와 전달한 문자열을 연결한 문자열 반환    
