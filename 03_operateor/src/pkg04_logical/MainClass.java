...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    boolean c = n1 == 20 && ++n2 == 20;// 숏 서킷에 의해서 ++n2 == 20 코드는 실행되지 않는다.false 반환해서 더 이상 안늘어남. 20그대로
    System.out.println(n2);
    
    boolean d = n1 == 20 && n2++ == 10;// 숏 서킷에 의해서 n2++ == 20 코드는 실행되지 않는다. 동작하지 않음
    ...
    boolean f = n1 == 10 || n2++ == 20; //true 숏 서킷에 n2++ == 20의해서 코드는 실행되지 않음
    boolean g = n1 == 10 || ++n2 == 10; //true 숏 서킷에 ++n2 == 20의해서 코드는 실행되지 않음
